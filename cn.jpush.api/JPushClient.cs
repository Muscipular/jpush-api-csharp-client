...
namespace cn.jpush.api
{
    ...
    public class JPushClient
    {
        ...
        /// </summary>
        /// <param name="payload">推送的数据结构，包含平台信息推送目标，通知内容，消息内容与可选参数</param>
        ...
        ///     想某个设备或者某设别列表推送一条通知，或者消息
        /// </summary>
        /// <param name="payloadString">推送的json结构，包含平台信息推送目标，通知内容，消息内容与可选参数</param>
        /// <returns>成功时返回sendno和messageid，失败时有异常抛出</returns>
        /// <exception cref="APIRequestException">包含http错误码：如401,404等，错误信息，JPush returen code和JPush returen mssage</exception>
        /// <exception cref="APIConnectionException">包含错误的信息</exception>
        ...
        /// <exception cref="APIRequestException">包含http错误码：如401,404等，错误信息，JPush returen code和JPush returen mssage</exception>
        /// <exception cref="APIConnectionException">包含错误的信息</exception>
        public ReceivedResult getReceivedApi(string msgIds)
        {
        ...
        /// </summary>
        /// <param name="msgIds">100 msgids to batch getting is supported.</param>
        public ReceivedResult getReceivedApi_v3(string msgIds)
        {
            return _reportClient.getReceiveds_v3(msgIds);
        }
